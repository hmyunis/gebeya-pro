...
export const targetOptions: { key: BroadcastTarget; label: string; description: string }[] = [
  ...
  },
  {
    key: 'role',
    label: 'By Role',
    description: 'Send to linked users in one platform role.',
  },
  {
    key: 'users',
  ...
  },
  {
    key: 'vip',
    label: 'VIP Users',
    description: 'Send to linked users with high order activity.',
  },
];

export const roleOptions: { key: BroadcastRole; label: string }[] = [
