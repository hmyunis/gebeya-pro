...
export type BroadcastKind = 'announcement' | 'news' | 'ad';
...
export type BroadcastRole = 'customer' | 'merchant' | 'admin';
...
export interface BroadcastUser extends Pick<User, 'id' | 'firstName' | 'username' | 'role'> {
